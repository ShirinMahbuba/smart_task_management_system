    ...
    public class UserRepo(StmsDbContext context)
    {
        ...
        public Result<User> Register(RegisterModel model)
        {
            ...
            try
            {
                ...
                {
                    UserID  = newUser.ID,
                    Action  = $"New account registered ({newUser.Email})",
                    LogTime = DateTime.Now
                });
                context.SaveChanges();
        ...
        public Result<User> Save(User model, int loggedInUserId)
        {
            ...
            try
            {
                ...
                objToSave.UpdatedBy = loggedInUserId;
                ...
                context.ActivityLogs.Add(new ActivityLog
                {
                    ...
                    Action  = $"Saved User#{objToSave.ID} ({objToSave.Name})",
                    LogTime = DateTime.Now
                });
                context.SaveChanges();
        ...
        public Result<User> Delete(int id, int loggedInUserId)
        {
            ...
            try
            {
                ...
                {
                    UserID  = loggedInUserId,
                    Action  = $"Deleted User#{id} ({objToDelete.Name})",
                    LogTime = DateTime.Now
                });
        ...
        public Result<List<ActivityLog>> GetActivityLogs()
        {
            ...
            try
            {
                result.Data = context.ActivityLogs
